...
public class PopupActivity15 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_15popup);
    ...
    View.OnClickListener mClick = new View.OnClickListener() {
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnPlay:
                    Intent ex1 = new Intent(PopupActivity15.this, HanoiMainActivity.class);
                    startActivity(ex1);
                    mp.stop();
                    finish();
                    break;
