...
public class MultipleMainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_11main3_multi);
    ...
    public void setOptions() {
        ...
        resultOfSum = n1 * n2 * n3;
        expressionTextView.setText(n1 + "x" + n2 + "x" + n3);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == positionOfAnswer) {
                ...
                incorrectAnswer = random.nextInt(1540);
