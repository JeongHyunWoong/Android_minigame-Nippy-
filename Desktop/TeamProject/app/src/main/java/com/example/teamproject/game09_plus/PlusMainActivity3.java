...
public class PlusMainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_09main3_plus);
    ...
    public void setOptions() {
        ...
        expressionTextView.setText(n1 + "+" + n2 + "+" + n3);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == positionOfAnswer) {
                ...
                incorrectAnswer = random.nextInt(299);
