...
public class PopupActivity01 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_01popup);
    ...
    View.OnClickListener mClick = new View.OnClickListener() {
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnPlay:
                    Intent ex1 = new Intent(PopupActivity01.this, ShakeGameActivity.class);
                    startActivity(ex1);
                    mp.stop();
                    finish();
                    break;
