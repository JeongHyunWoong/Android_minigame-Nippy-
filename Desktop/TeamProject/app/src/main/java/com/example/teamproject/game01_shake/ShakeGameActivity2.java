...
import com.example.teamproject.MySQLiteOpenHelper_shake;
import com.example.teamproject.R;

public class ShakeGameActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_01shakegame_layout2);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelper_shake(
                ShakeGameActivity2.this, // 현재 화면의 context
                "member1.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        String point = Integer.toString(count);
        et_highscore_score.setText("Score : " + count);
            ...
            switch (v.getId()) {
                case R.id.btnEnter:
                    ...
                    if(et_highscore_name.getText().toString().equals("")) {
                        ...
                        Toast.makeText(ShakeGameActivity2.this, "이름이 없어 AAA 자동 입력!", Toast.LENGTH_SHORT).show();
                        break;
                    }
...
//                    startActivity(intentJoinOk);
                    ...
                    ShakeGameActivity PA = (ShakeGameActivity)ShakeGameActivity.shakegame; // 다른 액티비티 종료 3, 다른 액티비티에서 객체 생성
                    PA.finish(); // 다른 액티비티 종료 4, 만든 객체로 원하는 작업 실행
                    finish();
                    break;

                case R.id.btnMain:
                    Intent ex1 = new Intent(ShakeGameActivity2.this, MainActivity.class);
                    startActivity(ex1);
                    finish();
                    mp.stop();
                    break;
                ...
                case R.id.button3:
                    Intent ex2 = new Intent(ShakeGameActivity2.this, ShakeGameActivity.class);
                    startActivity(ex2);
                    finish();
                    mp.stop();
                    break;
    ...
    public void onBackPressed() {
        if (ShakeGameActivity.handler2 != null) {
            ShakeGameActivity.handler2.removeMessages(0);
            ShakeGameActivity.handler2.removeCallbacks(null);
            ShakeGameActivity.handler2.removeCallbacksAndMessages(null);
        }
