...
import com.example.teamproject.LogoActivity;
...
public class PlusMainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_09main1_plus);
        ...
        Glide.with(PlusMainActivity1.this).load(R.drawable.answer).into(solution);
