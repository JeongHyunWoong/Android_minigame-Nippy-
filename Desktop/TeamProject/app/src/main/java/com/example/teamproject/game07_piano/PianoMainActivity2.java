...
import static com.example.teamproject.game07_piano.PianoMainActivity1.currentScore;
...
import com.example.teamproject.MySQLiteOpenHelper_piano;
import com.example.teamproject.R;

public class PianoMainActivity2 extends AppCompatActivity {

    //SQLITE 데이타베이스 관련변수
    SQLiteDatabase db;
    MySQLiteOpenHelper_piano helper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_07main2);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelper_piano(
                PianoMainActivity2.this, // 현재 화면의 context
                "member7.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        String point = Integer.toString(currentScore);
        et_highscore_score.setText("Score : " +currentScore );
            ...
            switch (v.getId()) {
                case R.id.btnEnter:
                    ...
                    if(et_highscore_name.getText().toString().equals("")) {
                        ...
                        Toast.makeText(PianoMainActivity2.this, "이름이 없어 AAA 자동 입력!", Toast.LENGTH_SHORT).show();
                        break;
                    }
...
//                    startActivity(intentJoinOk);
                    ...
                    PianoMainActivity1 PA = (PianoMainActivity1)PianoMainActivity1.pianogame; // 다른 액티비티 종료 3, 다른 액티비티에서 객체 생성
                    PA.finish(); // 다른 액티비티 종료 4, 만든 객체로 원하는 작업 실행
                    finish();
                    break;

                case R.id.btnMain:
                    Intent ex1 = new Intent(PianoMainActivity2.this, MainActivity.class);
                    startActivity(ex1);
                    finish();
                    mp.stop();
                    break;
                ...
                case R.id.button3:
                    Intent ex2 = new Intent(PianoMainActivity2.this, PianoMainActivity1.class);
                    startActivity(ex2);
                    finish();
                    mp.stop();
                    break;
    ...
    public void onBackPressed() {
        if (PianoMainActivity1.handler2 != null) {
            PianoMainActivity1.handler2.removeMessages(0);
            PianoMainActivity1.handler2.removeCallbacks(null);
            PianoMainActivity1.handler2.removeCallbacksAndMessages(null);
        }
