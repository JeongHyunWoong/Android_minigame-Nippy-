...
public class AOMainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_12main1_ao);
    ...
    public void setOptions() {
        ...
        expressionTextView.setText(n1 + "x" + n2 + "+" + n3 + "-" + n4);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == positionOfAnswer) {
                ...
                incorrectAnswer = random.nextInt(91);
