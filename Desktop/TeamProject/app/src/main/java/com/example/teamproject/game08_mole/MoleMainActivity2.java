...
import static com.example.teamproject.game08_mole.MoleMainActivity1.currentScore;
...
import com.example.teamproject.MySQLiteOpenHelper_mole;
import com.example.teamproject.R;

public class MoleMainActivity2 extends AppCompatActivity {

    //SQLITE 데이타베이스 관련변수
    SQLiteDatabase db;
    MySQLiteOpenHelper_mole helper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_08main2);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelper_mole(
                MoleMainActivity2.this, // 현재 화면의 context
                "member8.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
            ...
            switch (v.getId()) {
                case R.id.btnEnter:
                    ...
                    if(et_highscore_name.getText().toString().equals("")) {
                        ...
                        Toast.makeText(MoleMainActivity2.this, "이름이 없어 AAA 자동 입력!", Toast.LENGTH_SHORT).show();
                        break;
                    }
...
//                    startActivity(intentJoinOk);
                    ...
                    MoleMainActivity1 PA = (MoleMainActivity1)MoleMainActivity1.molegame; // 다른 액티비티 종료 3, 다른 액티비티에서 객체 생성
                    PA.finish(); // 다른 액티비티 종료 4, 만든 객체로 원하는 작업 실행
                    finish();
                    break;

                case R.id.btnMain:
                    Intent ex1 = new Intent(MoleMainActivity2.this, MainActivity.class);
                    startActivity(ex1);
                    finish();
                    mp.stop();
                    break;
                ...
                case R.id.button3:
                    Intent ex2 = new Intent(MoleMainActivity2.this, MoleMainActivity1.class);
                    startActivity(ex2);
                    finish();
                    mp.stop();
                    break;
    ...
    public void onBackPressed() {
        if (MoleMainActivity1.handler2 != null) {
            MoleMainActivity1.handler2.removeMessages(0);
            MoleMainActivity1.handler2.removeCallbacks(null);
            MoleMainActivity1.handler2.removeCallbacksAndMessages(null);
        }
