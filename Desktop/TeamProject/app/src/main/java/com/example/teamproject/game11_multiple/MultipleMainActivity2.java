...
public class MultipleMainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_11main2_multi);
    ...
    public void setOptions() {
        ...
        resultOfSum = n1 * n2;
        expressionTextView.setText(n1 + "x" + n2);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == positionOfAnswer) {
                ...
                incorrectAnswer = random.nextInt(362);
