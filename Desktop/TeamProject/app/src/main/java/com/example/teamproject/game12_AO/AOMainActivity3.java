...
public class AOMainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_12main3_ao);
    ...
    public void setOptions() {
        ...
        expressionTextView.setText(n1 + "+" + n2 + "x" + n3 + "-" + n4);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == positionOfAnswer) {
                ...
                incorrectAnswer = random.nextInt(271);
