...
public class Score13_teemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_teemo);

        //데이베이스 생성.
        helper = new MySQLiteOpenHelper_teemo(
                Score13_teemo.this, // 현재 화면의 context
                "member13.db",         // 파일명
                null,                // 커서 팩토리
                1);                  // 버전 번호

        //회원목록
        tv_score_list = (TextView)findViewById(R.id.teemo_list);
