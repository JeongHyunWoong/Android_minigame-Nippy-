...
public class AOMainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_12main2_ao);
    ...
    public void setOptions() {
        ...
        resultOfSum = n1 + n2 - n3 * n4;
        expressionTextView.setText(n1 + "+" + n2 + "-" + n3 + "x" + n4);
        ...
        for (int i = 0; i < 4; i++) {
            if (i == positionOfAnswer) {
                ...
                incorrectAnswer = random.nextInt(181);
